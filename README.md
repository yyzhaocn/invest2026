...
├── market/         # Market skills: fund-*/stock-*/block-* + 纸面交易全套 (portfolio/trade-journal/performance/scan/signal/backtest/position-size/fund-compare/fund-score)
├── shared/         # Favorites config & pick notes (local, not in git); shared/paper/ = 模拟盘数据
